...
const testimonialData = [
    {
        text: "Hiring Mariah as a virtual assistant was my first experience in this space, and she set the bar incredibly high. The finished work was polished, professional, and gave me real confidence in scaling my business.",
        name: "Alicia C.",
        role: "CEO, Your Step Sister LLC",
        img: "testmonies/ceo-magic-touch.jpg"
    },
    {
        text: "Working with Mariah was a game-changer. As my online store grew, she handled admin tasks, emails, and order organization so smoothly that I finally had breathing room to focus on growth.",
        name: "Danny Spenza",
